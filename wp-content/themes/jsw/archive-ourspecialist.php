...
?>
    <main id="primary" class="site-main">
        <section class="sub-page-banner cover no-repeat" style="background-image: url('<?= get_field('banner_image_our_specialist', 'options') ?>');">
        ...
        <section class="gap-bottom-lg gap-top-lg">
            <div class="container">
                <?php if (have_rows('our_specialist', 'options')) { ?>
                    <div class="row">
                        <div class="text-center col-md-10 mx-auto">
                            <?php while (have_rows('our_specialist', 'options')):the_row() ?>
