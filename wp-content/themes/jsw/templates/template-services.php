...
?>
    <main id="primary" class="site-main">
        <section class="sub-page-banner cover no-repeat" style="background-image: url('<?= get_field('banner_image_services', $hospital ? $hospital->ID : 'options') ?>');">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="breadcrumb-wrap">
                                <span class="gt"><span>Home</span> <span class="mx-3">></span> </span> <span class="rt"><?= ucwords(get_the_title()) ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="gap-bottom-lg gap-top-lg">
            <div class="container">
                <?php if (have_rows('services', $hospital ? $hospital->ID : 'options')) { ?>
                    <div class="row">
                        <div class="text-center col-md-10 mx-auto">
                            <?php while (have_rows('services', $hospital ? $hospital->ID : 'options')):the_row() ?>
